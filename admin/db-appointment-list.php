...
$sql = "SELECT * FROM booking WHERE status = 'pending' ORDER BY booking_id DESC";
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="ap-book-approved.php" method="post">
                                                <input type="hidden" name="book_id" value="<?php echo $row['booking_id'];?>">
                                                <button type="submit" name="action" value="approve" class="btn btn-sm btn-primary" onclick="return confirm('Are you sure you want to approve this booking?');">Approve</button>
                                                <button type="submit" name="action" value="reject" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to reject this booking?');"> Reject</button>
                                            </form>
                                        </td>
                                    </tr>
                                    <?php } ?>
