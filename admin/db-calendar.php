                ...
                <div class="container-fluid">
                    <div class="container">
                        ...
                        <div class="head-addevent">
                            <button type="button" class="btn btn-primary1" data-bs-toggle="modal" data-bs-target="#addEventModal">
...
nextBtn.addEventListener('click', () => {
  ...
  function renderCalendar() {
    ...
    for (let i = 1; i <= daysInMonth; i++) {
      const currentDateClass = (i === currentDate.getDate() && currentMonth === currentDate.getMonth() && currentYear === currentDate.getFullYear()) ? 'today' : '';
      let hasEventClass = '';
      let eventDotHTML = '';
      let bookingDotHTML = '';
  ...
  saveEventButton.addEventListener('click', function(event) {
    ...
    const formData = `&eventDate=${encodeURIComponent(eventDate)}&eventDescription=${encodeURIComponent(eventDescription)}`;
    xhr.send(formData);
  });
