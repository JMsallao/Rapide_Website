...
if (isset($_POST['book_id'], $_POST['reason'])) {
        ...
        if ($stmt_select->fetch()) {
            ...
            if (filter_var($client_email, FILTER_VALIDATE_EMAIL)) {
                ...
                try {
                    ...
                    $mail->Body    = "Dear " . htmlspecialchars($client_name) . ",<br><br>Your booking for " . htmlspecialchars($service) . " has been rejected for the following reason:<br><br>" . htmlspecialchars($reject_reason) . "<br><br>Please contact us for further details.<br><br>Best regards,<br>A.C Tech";
                    $mail->AltBody = "Dear " . htmlspecialchars($client_name) . ",\n\nYour booking for " . htmlspecialchars($service) . " has been rejected for the following reason:\n\n" . htmlspecialchars($reject_reason) . "\n\nPlease contact us for further details.\n\nBest regards,\nA.C Tech";
